...
namespace SM\PWABanner\Block\Adminhtml\Pwabanner;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_pwabanner';
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('current_banner')->getId()) {
            return __("Edit Banner '%1'", $this->escapeHtml($this->_coreRegistry->registry('current_banner')->getTitle()));
        } else {
